const features = [
  {
    title: "Free Shipping",
    description: "Enjoy free shipping on all orders above $50. Fast, reliable delivery straight to your doorstep.",
  ...
  {
    title: "Easy Returns",
    description: "Not satisfied? Return your purchase within 30 days for a full, hassle-free refund.",
    ...
    <section className="py-20 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose SmartShop</h2>
          <p className="text-gray-400 max-w-2xl mx-auto">We provide the best shopping experience with unmatched quality and service.</p>
        </div>
